...
{
    public class GetAuthorsQueryHandler : IRequestHandler<GetAuthorsQuery, List<GetAuthorsQueryResposne>>
    {
        ...
        public async Task<List<GetAuthorsQueryResposne>> Handle(GetAuthorsQuery request, CancellationToken cancellationToken)
            => await db.Authors
                ...
                .Select(a => new GetAuthorsQueryResposne
                {
